...
const namespace = "config-propagator-system"

// serviceAccountName created for the project
const serviceAccountName = "config-propagator-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "config-propagator-controller-manager-metrics-service"
				...
				fmt.Sprintf(`{
					"spec": {
						"containers": [{
							...
							"image": "curlimages/curl:latest",
							"command": ["/bin/sh", "-c"],
							"args": ["curl -v -k http://%s.%s.svc.cluster.local:%s/metrics"],
							"securityContext": {
